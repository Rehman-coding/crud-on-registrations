...
<?php
 ...
 $query = "INSERT INTO  registration_tb(name,email,fname,gender,profession,number,address)
                VALUES ('$name','$email','$fname','$gender','$profession','$number','$address')";
                ...
                <form method="post" >
                    ...
                    <form  class="form-horizontal" method="post" >
                        ...
                        <div id="div_id_email" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md emailinput form-control" id="id_email" name="email" placeholder="Your current email address" style="margin-bottom: 10px" type="text" />
                            </div>     
                        </div>
                        ...
                        <div id="div_id_name" class="form-group required"> 
                            ...
                            <div class="controls col-md-8 "> 
                                <input class="input-md textinput textInput form-control" id="id_name" name="fname" placeholder="Your Frist name and Last name" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div>
                        ...
                        <div id="div_id_company" class="form-group required"> 
                            ...
                            <div class="controls col-md-8 "> 
                                 <input class="input-md textinput textInput form-control" id="id_company" name="pro" placeholder="Your Profession name" style="margin-bottom: 10px" type="text" />
                            </div>
                        </div> 
                        ...
                        <div id="div_id_location" class="form-group required">
                            ...
                            <div class="controls col-md-8 ">
                                <input class="input-md textinput textInput form-control" id="id_location" name="address" placeholder="Your Pincode and City" style="margin-bottom: 10px" type="text" />
                            </div> 
                        </div>
